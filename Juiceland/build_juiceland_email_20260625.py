#!/usr/bin/env python3
"""
Build Juiceland Daily Sales Report email.html — 2026-06-25 (yesterday, Asia/Bangkok).
Run date: 2026-06-26
"""
...
# Query A — daily totals per branch, 30-day window (May 27 – Jun 25)
...
# Top-20 per branch from Query B (yesterday 2026-06-25, sorted by qty desc)
QB_MW1 = [
    ('EVIAN', 52, 5831.80, 6),
    ('COCONUT READY TO DRINK', 16, 2542.06, 4),
    ('PRIDE PARROT RED', 10, 1869.17, 2),
    ('PAPAYA 400G.', 9, 1261.69, 3),
    ('3 kinds of fruit400g', 9, 1261.70, 2),
    ('WATERMELON 400G.', 8, 1121.50, 3),
    ('PRIDE PARROT YELLOW', 8, 1495.35, 3),
    ('S3 WATERMELON SMOOTHIE 22OZ', 6, 1037.40, 3),
    ('DRAGON FRUIT 400G.', 6, 841.13, 2),
    ('S5 MANGO SMOOTHIE 16OZ', 5, 747.66, 2),
    ('WATERMELON JUICE BOTTLE', 5, 864.48, 3),
    ('MANGO 400G.', 5, 747.65, 3),
    ('YS1 MANGO YOGHURT SMOOTHIE 16OZ', 4, 654.20, 3),
    ('C6 PINEAPPLE COLD PRESSED 16OZ', 4, 691.59, 3),
    ('CI3 ICED AMERICANO 22OZ', 4, 672.88, 2),
    ('S2 MANGO PASSION SMOOTHIE 16OZ', 4, 598.12, 2),
    ('CH2 HOT AMERICANO', 3, 378.51, 2),
    ('CARROT JUICE BOTTLE', 3, 518.70, 3),
    ('SOFT-SLUSH! ORIGINAL', 3, 448.59, 2),
    ('S1 COCONUT SMOOTHIE 16OZ', 3, 504.66, 3),
]
QB_SE3 = [
    ('EVIAN', 24, 2691.60, 4),
    ('PINEAPPLE 400G.', 11, 1542.07, 4),
    ('WATERMELON 400G.', 10, 1401.88, 3),
    ('3 kinds of fruit400g', 10, 1401.88, 3),
    ('Chicken Club Croissant', 5, 696.26, 2),
    ('LYCHEE 400G.', 4, 635.51, 1),
    ('PRIDE PARROT RED', 7, 1308.42, 4),  # merged clean(4) + malformed-\n(3)
    ('S5 MANGO SMOOTHIE 16OZ', 4, 598.12, 1),
    ('T1 ICED THAI MILK TEA 16OZ', 3, 420.56, 2),
    ('S1 COCONUT SMOOTHIE 22OZ', 3, 574.77, 1),
    ('S2 MANGO PASSION SMOOTHIE 16OZ', 3, 448.60, 1),
    ('CH3 HOT CAPPUCCINO', 3, 420.56, 2),
    ('COCONUT READY TO DRINK', 3, 476.64, 2),
    ('MANGO 400G.', 3, 448.59, 1),
    ('S4 MIXBERRY SMOOTHIE 16OZ', 2, 299.06, 2),
    ('DRAGON FRUIT 400G.', 2, 280.38, 2),
    ('C4 MANGO PASSION COLD PRESSED 22OZ', 2, 392.52, 1),
    ('MANGO PASSION JUICE (BOTTLE) 300 ML', 2, 345.78, 2),
    ('YS2 STRAWBERRY YOGHURT SMOOTHIE 22OZ', 2, 373.84, 2),
    ('C7 GREEN APPLE&CELERY&PINEAPPLE COLD PRESSED 22OZ', 2, 392.51, 2),
]
QB_PKT = [
    ('Evian 500ml.', 8, 897.20, 2),
    ('Mango 400g.', 5, 747.65, 2),
    ('CH1 Cappuccino', 5, 700.94, 2),  # merged clean(3) + trailing-\n(2)
    ('Watermelon 400g.', 4, 560.76, 1),
    ('Watermelon Cold Pressed 300ml', 3, 518.69, 2),
    ('S5 mango smoothie 16oz', 3, 448.59, 1),
    ('Mango Yoghurt Smoothie 22oz', 2, 373.84, 2),
    ('Iced Cappuccino 22oz', 2, 314.29, 2),
    ('CI5 Iced Latte 16oz', 2, 317.76, 1),
    ('Salt Grilled Salmon Onigiri', 2, 203.74, 1),
    ('Coconut', 2, 317.76, 1),
    ('Mango Passion Smoothie 22oz', 1, 172.89, 1),
    ('Coconut Smoothie 22oz', 1, 191.58, 1),
    ('C1 Guava&green apple cold pressed 16oz', 1, 172.90, 1),
    ('Iced Thai Milk Tea 22oz', 1, 163.55, 1),
    ('Mango Passion Cold Pressed 22oz', 1, 196.26, 1),
    ('Iced Thai Tea With Lime 22oz', 1, 163.55, 1),
    ('CH2 Caffe latte', 1, 140.19, 1),
    ('Fanta Strawberry', 1, 74.77, 1),
    ('Fanta Orange', 1, 74.77, 1),
]

# Dormant SKUs — qty_30d >= 3, malformed \n memos dropped, still dormant as of Jun 25
# (memo, last_sold_str, qty_30d, days_sold_30d, rev_30d)
DORMANT_MW1 = [
    ('MAEVAREE MANGO STICKY RICE SMOOTHIE 22OZ', '2026-06-08', 19, 10, 4041.08),
    ('Overnight Oat mango 16 oz',                '2026-06-06', 12, 9,  3016.80),
    ('MAEVAREE MANGO YOGHURT STICKY RICE SMOOTHIE 22OZ', '2026-06-12', 10, 6, 2149.50),
    ('BLUEBERRY GREEK YOGURT',                   '2026-06-05', 5,  4,  883.19),
    ('Mango Sticky Rice\xa0(Box)',               '2026-06-01', 3,  3,  501.85),
]
DORMANT_SE3 = [
    ('Cantaloupe\xa0400 g (Pack)',               '2026-06-09', 35, 13, 4906.60),
    ('MANGO (1 PCS.) 380 G.',                    '2026-06-18', 32, 14, 4486.04),
    ('MAEVAREE MANGO STICKY RICE SMOOTHIE 22OZ', '2026-06-12', 27, 12, 5782.17),
    ('MANGO (2 PCS.) 760 G.',                    '2026-06-18', 21, 9,  5887.81),
    ('HOT CHOCOLATE 8 oz',                       '2026-05-29', 13, 3,  1579.49),
    ('MAEVAREE MANGO YOGHURT STICKY RICE SMOTHIE 22OZ', '2026-06-12', 13, 8, 2794.36),
    ...
    ('Golden Harmony Greek Yogur',               '2026-05-31', 5,  3,  883.20),
    ('SEEDLESS GRAPE 400G.',                     '2026-06-08', 5,  2,  747.65),
    ('T2 ICED THAI TEA WITH LIME 22OZ',          '2026-06-17', 4,  4,  654.20),
    ('Mango Sticky Rice\xa0(Box)',               '2026-05-31', 4,  3,  669.16),
...
DORMANT_PKT = [
    ...
    ('C7 Green Apple & Celery & Pineapple Cold Pressed 16 oz.', '2026-06-18', 7, 6, 1210.30),
    ('T2 Iced Thai tea with lime 16oz',          '2026-06-11', 4,  3,  560.76),
    ('singha soda water 325ml',                  '2026-06-04', 4,  2,  243.00),
    ('Nestle Water 600 ml',                      '2026-06-06', 3,  3,  28.05),
]
...
last7_dates = dates_sorted[-7:]  # Jun 19–25
...
# ─── FORECAST (today = Friday 2026-06-26) ───
fc_date = run_date  # Friday
...
mw1_fri = same_wday_history(mw1, fc_date)
se3_fri = same_wday_history(se3, fc_date)
pkt_fri = same_wday_history(pkt, fc_date)

def forecast_branch(fri_vals, branch_vals, all_dates):
    base = sum(fri_vals) / len(fri_vals) if fri_vals else 0
    last7_vals = [branch_vals[d] for d in all_dates[-7:]]
    trend_adj = (base + sum(last7_vals) / 7) / 2
    stdev = (math.sqrt(sum((x - base)**2 for x in fri_vals) / len(fri_vals))
             if len(fri_vals) > 1 else base * 0.12)
...
mw1_fc, mw1_band, mw1_conf = forecast_branch(mw1_fri, mw1, dates_sorted)
se3_fc, se3_band, se3_conf = forecast_branch(se3_fri, se3, dates_sorted)
pkt_fc, pkt_band, pkt_conf = forecast_branch(pkt_fri, pkt, dates_sorted)
...
NP_DRINKS_ROWS = [
    {'memo': 'PRIDE PARROT RED', 'launch': '1 Jun 2026', 'notes': 'MW1, SE3, PKT',
     'total_units': 285, 'total_rev': '53,295', 'branch_split': 'MW1·SE3·PKT',
     'yest_units': 20, 'status_badge': '🟢 on target'},
    {'memo': 'PRIDE PARROT YELLOW', 'launch': '1 Jun 2026', 'notes': 'MW1, SE3',
     'total_units': 175, 'total_rev': '32,725', 'branch_split': 'MW1·SE3',
     'yest_units': 9, 'status_badge': '🟢 on target'},
    {'memo': 'MOOVE CLEAR PROTEIN', 'launch': '13 Jun 2026', 'notes': 'MW1 — below target',
     'total_units': 40, 'total_rev': '9,000', 'branch_split': 'MW1',
     'yest_units': 0, 'status_badge': '🟡 below target'},
    {'memo': 'LYCHEE CLEAR PROTEIN', 'launch': '25 Jun 2026', 'notes': 'MW1, SE3 — first day',
     'total_units': 3, 'total_rev': '675', 'branch_split': 'MW1·SE3',
     'yest_units': 3, 'status_badge': '⚪ new — 1st day'},
    {'memo': 'GRAPE CLEAR PROTEIN', 'launch': '25 Jun 2026', 'notes': 'MW1 — first day',
     'total_units': 3, 'total_rev': '675', 'branch_split': 'MW1',
     'yest_units': 3, 'status_badge': '⚪ new — 1st day'},
    {'memo': 'Fanta Orange 450ml. (Bottle)', 'launch': '31 May 2026', 'notes': 'PKT',
     'total_units': 26, 'total_rev': '1,944', 'branch_split': 'PKT',
     'yest_units': 1, 'status_badge': '🟢 on target'},
    {'memo': 'Fanta Strawberry 450ml. (Bottle)', 'launch': '1 Jun 2026', 'notes': 'PKT',
     'total_units': 27, 'total_rev': '2,019', 'branch_split': 'PKT',
     'yest_units': 1, 'status_badge': '🟢 on target'},
    {'memo': 'Sprite 500ml. (Bottle)', 'launch': '30 May 2026', 'notes': 'PKT',
     'total_units': 21, 'total_rev': '1,570', 'branch_split': 'PKT',
...
NP_FRUIT_ROWS = [
    {'memo': 'LYCHEE 400G.', 'launch': '28 May 2026', 'notes': 'MW1, SE3',
     'total_units': 58, 'total_rev': '9,217', 'branch_split': 'MW1·SE3',
     'yest_units': 4, 'status_badge': '🟢 on target'},
    {'memo': 'MANGOSTEEN 400g.', 'launch': '28 May 2026', 'notes': 'MW1, SE3 — SE3 dormant 24d',
     'total_units': 6, 'total_rev': '1,402', 'branch_split': 'MW1·SE3',
     'yest_units': 0, 'status_badge': '🔴 no sales — SE3 dormant'},
    {'memo': 'ROSE APPLE 400G.', 'launch': '30 May 2026', 'notes': 'SE3, MW1',
     'total_units': 22, 'total_rev': '3,140', 'branch_split': 'SE3·MW1',
     'yest_units': 0, 'status_badge': '🟡 below target — no sales yesterday'},
    {'memo': 'Orange 400g Pack', 'launch': '18 Jun 2026', 'notes': 'SE3 — strong seasonal pick-up',
     'total_units': 18, 'total_rev': '2,523', 'branch_split': 'SE3',
     'yest_units': 0, 'status_badge': '⚪ not sold yesterday (last sold 23 Jun)'},
]

drinks_total_units = sum(r['total_units'] for r in NP_DRINKS_ROWS)
drinks_total_rev   = 102_071
drinks_n           = len(NP_DRINKS_ROWS)
drinks_yest_units  = 20 + 9 + 1 + 1  # PPR + PPY + Fanta Ora + Fanta Straw

fruit_total_units  = sum(r['total_units'] for r in NP_FRUIT_ROWS)
fruit_total_rev    = 16_282
fruit_n            = len(NP_FRUIT_ROWS)
fruit_yest_units   = 4  # Lychee SE3 only

np_total_units = drinks_total_units + fruit_total_units
np_total_rev   = drinks_total_rev + fruit_total_rev

# ─── SEASONAL (Query E) ───
grape_total_rev  = 243375
grape_last_mw1   = '23 Jun 2026'  # SEEDLESS GRAPE 400G. at MW1
grape_last_se3   = '8 Jun 2026'   # SEEDLESS GRAPE 400G. at SE3

# Revenue from new seasonal fruits in 30-day window
mw1_fruit_rev = 3021.0 + 701.0 + 299.0   # LYCHEE + MANGOSTEEN + ROSE APPLE
se3_fruit_rev = 6196.0 + 701.0 + 2841.0 + 2523.0  # LYCHEE + MANGOSTEEN + ROSE APPLE + ORANGE

mw1_fruit_per_day = mw1_fruit_rev / 30  # ≈ 134/day
se3_fruit_per_day = se3_fruit_rev / 30  # ≈ 409/day

mw1_grape_baseline = 339  # historical grape rev/day
se3_grape_baseline = 251

mw1_coverage = mw1_fruit_per_day / mw1_grape_baseline * 100  # ≈ 40%
se3_coverage = se3_fruit_per_day / se3_grape_baseline * 100  # ≈ 163%
...
def coverage_gap_display(grape_baseline, fruit_per_day):
    diff = grape_baseline - fruit_per_day
    if diff <= 0:
        return f'+฿{fmt(round(-diff))}/d surplus'
    return f'-฿{fmt(round(diff))}/d gap'

def coverage_monthly_display(grape_baseline, fruit_per_day):
    diff = grape_baseline - fruit_per_day
    if diff <= 0:
        return f'+฿{fmt(round(-diff * 30))}/month'
    return f'-฿{fmt(round(diff * 30))}/month'
...
# ─── COMMENTARY & ANOMALIES ───

commentary_text = (
    f'Yesterday ({report_date.day} June 2026 · {report_day_th}), combined net was ฿{fmt(comb_yest)} ex-VAT, '
    f'{abs(signed_pct):.1f}% below the 30-day average. '
    f'MW1 held steady at ฿{fmt(mw1_yest)} ({mw1_vs30:+.1f}% vs avg), '
    f'SE3 dipped to ฿{fmt(se3_yest)} ({se3_vs30:+.1f}% vs avg). '
    f'PKT recorded ฿{fmt(pkt_yest)}, a notable {pkt_vs30:.1f}% below its 30-day average — '
    f'the weakest individual-branch result in the trailing window. '
    f'Tomorrow (Friday) the combined forecast is '
    f'฿{fmt(comb_fc - comb_band)}–{fmt(comb_fc + comb_band)}.'
)

anomaly_items = [
    {'anomaly_text': f'PKT {pkt_vs30:.1f}% vs 30d avg (฿{fmt(pkt_yest)} vs avg ฿{fmt(pkt_avg)}) — lowest PKT reading in trailing window',
     'anomaly_section_ref': 'Chart §3'},
    {'anomaly_text': 'SE3 Cantaloupe 400g — 35 units in 30d, dormant 16 days since 9 Jun',
     'anomaly_section_ref': 'Dormant SKUs §7'},
    {'anomaly_text': 'SE3 Mango (1+2 PCS.) — combined ฿10,374 in 30d, last sold 18 Jun (7 days dormant)',
     'anomaly_section_ref': 'Dormant SKUs §7'},
    {'anomaly_text': f'{dormant_count} total dormant SKUs (5 MW1, 15 SE3, 7 PKT) requiring review',
     'anomaly_section_ref': 'Dormant SKUs §7'},
    {'anomaly_text': f'MW1 seasonal fruit coverage only {mw1_coverage:.0f}% of grape baseline (฿{fmt(round(mw1_fruit_per_day))}/d vs ฿{mw1_grape_baseline}/d)',
...
seasonal_skus = [
    {'fruit_emoji': '🍈', 'memo': 'LYCHEE 400G.', 'launch': '28 May 2026',
     'mw1_units': '19', 'mw1_per_day': f'{3021/30:.0f}',
     'se3_units': '39', 'se3_per_day': f'{6196/30:.0f}'},
    ...
    {'fruit_emoji': '🌸', 'memo': 'ROSE APPLE 400G.', 'launch': '30 May 2026',
     ...
     'se3_units': '20', 'se3_per_day': f'{2841/30:.0f}'},
...
seasonal_coverage = [
    {
        ...
        'daily_gap':         coverage_gap_display(mw1_grape_baseline, mw1_fruit_per_day),
        'monthly_impact':    coverage_monthly_display(mw1_grape_baseline, mw1_fruit_per_day),
    ...
    },
    {
        ...
        'daily_gap':         coverage_gap_display(se3_grape_baseline, se3_fruit_per_day),
        'monthly_impact':    coverage_monthly_display(se3_grape_baseline, se3_fruit_per_day),
...
scalars = {
    ...
    'generated_timestamp':   '2026-06-26 08:00',
    ...
    'np_summary_line':       f'{drinks_n + fruit_n} new SKUs launched May–Jun 2026 · Drinks · Seasonal Fruits',
    ...
    'new_cat_n':             '0',
    'new_cat_todate_units':  '0',
    'new_cat_todate_rev':    '0',
