...
- **fallback chat_id:** none resolved (owner's corporate email is not resolvable to an open_id via `lark_batch_get_user_id`). On primary-send failure, fail loud to the owner by email instead.
