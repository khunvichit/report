...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group (resolved via `lark_list_chats` on the 9 Aug 2026 run).
- **fallback chat_id:** owner DM (vichit@sfb.co.th) — no second group identified yet.
