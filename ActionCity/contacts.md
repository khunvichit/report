...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" Lark group (resolved via lark_list_chats).
- **fallback chat_id:** owner DM `vichit@sfb.co.th` (email lookup) as backup.
