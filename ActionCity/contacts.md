...
- **fallback chat_id:** `oc_e253dcc37d240dd674b18ee613e46ab2` — "Ops Board: Notification" group (owner DM could not be resolved: `vichit@sfb.co.th` is a corporate email and `lark_batch_get_user_id` only supports personal emails).
