...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` (ActionCity TH) — resolved via `lark_list_chats` 2026-08-02.
- **fallback:** owner DM, `vichit@sfb.co.th` via `receive_id_type=email`.
