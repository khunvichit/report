...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group (resolved via `lark_list_chats` on 2026-07-06).
- **fallback chat_id:** owner DM (email `vichit@sfb.co.th`) — no second ActionCity-specific group exists yet.
