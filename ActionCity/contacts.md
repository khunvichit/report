...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` (ActionCity TH group) — resolved 15 Aug 2026 via `lark_list_chats`.
- **fallback chat_id:** owner DM (vichit@sfb.co.th) via `lark_send_message` with `receive_id_type: email`.
