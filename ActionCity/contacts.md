...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` (ActionCity TH) — resolved via `lark_list_chats` on 23 Aug 2026.
- **fallback chat_id:** owner DM (vichit@sfb.co.th) — no second ActionCity-specific group exists yet; fall back to the owner DM if the primary send fails.
