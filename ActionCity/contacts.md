...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group (resolved via `lark_list_chats` on 24 Aug 2026).
- **fallback chat_id:** owner DM (vichit@sfb.co.th) — no second ActionCity-specific group exists yet.
