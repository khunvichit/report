...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group (resolved via `lark_list_chats` 2026-08-04).
- **fallback chat_id:** owner DM (vichit@sfb.co.th, resolved via `receive_id_type=email` on `lark_send_message`).
