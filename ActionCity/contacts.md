...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group (resolved via `lark_list_chats` on 2026-09-25).
- **fallback chat_id:** owner DM (vichit@sfb.co.th) — no dedicated second group found; use `lark_send_message` with `receive_id_type: email` as fallback.
