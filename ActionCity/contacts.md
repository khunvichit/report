...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` (chat name: "ActionCity TH") — resolved via `lark_list_chats` on 2026-07-25.
- **fallback:** owner DM (vichit@sfb.co.th) — no second ActionCity-specific group exists yet; DM used as backup.
