...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" (resolved via `lark_list_chats` 2026-08-06).
- **fallback chat_id:** owner DM `vichit@sfb.co.th` (no second ActionCity-specific group found among bot's chats; revisit if one is created).
