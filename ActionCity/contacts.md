...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` (group: "ActionCity TH") — resolved via `lark_list_chats` on 2026-09-23.
- **fallback chat_id:** owner DM (vichit@sfb.co.th, via `receive_id_type: email`) — no second ops group identified.
