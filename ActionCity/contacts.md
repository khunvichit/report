...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group (resolved via `lark_list_chats` on 16 Sep 2026; no better-named ActionCity ops/management group exists in the bot's chat list).
- **fallback:** owner DM — `vichit@sfb.co.th` via `lark_send_message` with `receive_id_type: email`.
