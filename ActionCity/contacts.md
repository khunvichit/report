...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group (resolved via `lark_list_chats` on 7 Aug 2026 run).
- **fallback chat_id:** owner DM (vichit@sfb.co.th via email) — no second ActionCity-specific group found; escalate to owner if the primary chat fails.
