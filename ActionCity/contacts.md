...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` (ActionCity TH) — resolved via `lark_list_chats` on 2026-07-02.
- **fallback chat_id:** owner DM (vichit@sfb.co.th) as backup.
