...
- **chat_id:** `oc_4dabe0f3436e1201813c8cea6e38dbb1` — "ActionCity TH" group, resolved via `lark_list_chats` (2026-09-24).
- **fallback chat_id:** owner DM (vichit@sfb.co.th) — no second group found; use owner email as fallback.
